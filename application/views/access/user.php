...
<div class="content-wrapper" ng-controller='mUserCtrl'>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Current User List</h3>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="row" style="margin-bottom: 10px">
                  <div class="col-sm-2">
                    <button class="btn btn-sm btn-success btn-block" ng-click="addUser()" >Add New User</button>
                  </div>
                ...
                <div class="table table-responsive">
                  <table class="table table-striped">
                    ...
                    <tr ng-if="(users | filter:searchTable).length < 1">
                      <td colspan="4"><b><i>No match data found</i></b></td>
                    </tr>
                    <tr ng-repeat="u in users | filter:searchTable">
                      <td>{{$index + 1}}</td>
                      <td>{{u.adm_code}}</td>
                      <td>{{u.adm_code}}</td>
                      <td align="right">
      ...
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="box-body">
            ...
            <button class="btn btn-sm btn-danger" ng-click="cancelMe()" ><i class="fa fa-remove"></i>&nbsp; Close</button>
