        ...
        <div class="modal-header" style="background-color: #8eaadb;">
          ...
          <div class="row" style="margin-top: -10px;">
            ...
            <div class="col-xs-12 hidden-sm hidden-md hidden-lg show-xs">
              <div class="col-xs-6">
                <img ng-src="{{base_url}}image/project/{{header.project_image}}" width="80" height="100">
              </div>
              <div class="col-xs-6" align="right">
                <img ng-src="{{base_url}}image/prov/{{header.prov_image}}" width="80" height="100">
              </div>
            </div>
            ...
            <div class="col-xs-12 hidden-sm hidden-md hidden-lg show-xs" align="center" style="color: white;">
              ...
              <b>{{header.project_name}} Provinsi {{(header.ews_area).split(" - ")[2]}} </b>
            </div>
            ...
            <div class="col-sm-12 hidden-xs">
              <div class="row" style="color: white;">
                ...
                <div class="col-sm-2" align="right" style="padding: 10px;">
                  <img ng-src="{{base_url}}image/prov/{{header.prov_image}}" width="70" height="80">
                </div>
            ...
            <div class="col-sm-12 table table-responsive" style="margin-top: 10px;">
              <table class="table table-condensed table-bordered">
                ...
                <tr ng-repeat="his in datafilters">
                  ...
                  <td align="center">
                    <img ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '' && his.ews_arus_lam_stop != '0' )" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_merah_on.gif">

                    <img ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '' && his.ews_arus_lam_stop == '0' )" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_merah_off_rusak.png">

                    <img ng-if="(his.ews_arah == 'NONE' || his.ews_arah == '')" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_merah_off.png">

                    <span ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '' && his.ews_arus_lam_stop != '0')"><b>ON</b></span>
                    <span ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '' && his.ews_arus_lam_stop == '0')"><b>RUSAK</b></span>

                    <span ng-if="(his.ews_arah == 'NONE' || his.ews_arah == '')"><b>OFF</b></span>
                  ...
                  <td align="center">
                    ...
                    <table class="" border="0">
                      <tr>
                        <td colspan="2" align="center">
                          <img ng-if="( (his.ews_arus_lam_left != '0' || his.ews_arus_lam_right != '0') && (his.ews_arah == '' || his.ews_arah == 'NONE' || his.ews_arah == 'LEFT' || his.ews_arah == 'RIGHT' ) )" class="img_icon_larger" ng-src="{{base_url}}image/indicator/{{his.arah_icon}}">

                          <img ng-if="(his.ews_arus_lam_left == '0' && his.ews_arah == 'NONE' )" class="img_icon_larger" ng-src="{{base_url}}image/indicator/{{his.arah_icon}}">

                          <img ng-if="(his.ews_arus_lam_left == '0' && his.ews_arah == 'LEFT' )" class="img_icon_larger" ng-src="{{base_url}}image/indicator/arah_kiri_rusak.png">

                          <img ng-if="(his.ews_arus_lam_right == '0' && his.ews_arah == 'RIGHT' )" class="img_icon_larger" ng-src="{{base_url}}image/indicator/arah_kanan_rusak.png">
                  ...
                  <td align="center">
                    <img ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '')" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_kuning_off.png">

                    <img ng-if="( (his.ews_arah == 'NONE' || his.ews_arah == '') && his.ews_arus_lam_flash != '0' )" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_kuning_on.gif">

                    <img ng-if="( (his.ews_arah == 'NONE' || his.ews_arah == '') && his.ews_arus_lam_flash == '0' )" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_kuning_off_rusak.png">

                    <span ng-if="(his.ews_arah == 'NONE' || his.ews_arah == '')"><b>ON</b></span>
                    <span ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '')"><b>OFF</b></span>
