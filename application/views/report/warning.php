...
<div class="content-wrapper" ng-controller='rWlCtrl'>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody >
                      <tr ng-repeat-start="u in reports | filter:searchTable">
                        <td>{{$index + 1}}</td>
                        <td align="center">{{u.wl_sn}}</td>
                        <td>{{u.lokasi}}</td>
                        <td align="center">{{u.wl_ip}}</td>
...
<!--                           <a href="{{u.wl_cctv}}" ng-if="u.tfc_cctv" target="_blank" class="btn btn-primary btn-xs btn-block">
                            CCTV
                          </a>
                          <a href="{{u.wl_cctv}}" ng-if="!u.tfc_cctv" target="_blank" class="btn btn-primary btn-xs btn-block">
                            CCTV
...
<!--                           <a href="{{u.wl_street_view}}"  target="_blank" class="btn btn-primary btn-xs btn-block">
                            Street View
                          </a>
...
<!--                           <a href="" ng-click="showSensor(u)" target="_blank" class="btn btn-primary btn-xs btn-block">
 ...
 -->
                          ...
                          <b>{{u.wl_install_date}}</b>

                          <br>
                          <br>
                          <span>Tanggal Perbaikan</span><br>
                          <b>{{u.wl_maintenance_date}}</b>
                        ...
                        <td align="center"><b>{{u.wl_install_date | date:'dd MMMM yyyy'}}</b> <br>{{u.install_age}} Hari </td>
                        <td align="center"><b>{{u.wl_maintenance_date | date:'dd MMMM yyyy'}}</b> <br> {{u.maintenance_age}} Hari </td>
                        <td align="center">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><b>Data Warning Light</b></h4>
        </div>
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-sm-12">
              ...
              <table class="table">
                ...
                <tr bgcolor="#d5dce4">
                  ...
                  <td width="30">:</td>
                  <td>{{dataumum.wl_sn}} / {{dataumum.wl_ip}}</td>
                </tr>
                <tr bgcolor="#acb9ca">
                  <td>2</td>
                  <td>Lokasi / ALamat Jalan</td>
                  <td>:</td>
                  <td>{{dataumum.wl_jalan}}</td>
                </tr>
                <tr bgcolor="#d5dce4">
                  <td>3</td>
                  <td>Desa / Kelurahan</td>
                  <td>:</td>
                  <td>{{dataumum.wl_desa}}</td>
                </tr>
                <tr bgcolor="#acb9ca">
                  <td>4</td>
                  <td>Kecamatan</td>
                  <td>:</td>
                  <td>{{(dataumum.wl_area).split(" - ")[0]}}</td>
                </tr>
                <tr bgcolor="#d5dce4">
                  <td>5</td>
                  <td>Kabupaten</td>
                  <td>:</td>
                  <td>{{(dataumum.wl_area).split(" - ")[1]}}</td>
                </tr>
                <tr bgcolor="#acb9ca">
                  <td>6</td>
                  <td>Provinsi</td>
                  <td>:</td>
                  <td>{{(dataumum.wl_area).split(" - ")[2]}}</td>
                </tr>
                <tr bgcolor="#d5dce4">
                  <td>7</td>
                  <td>Koordinat</td>
                  <td>:</td>
                  <td>{{dataumum.wl_loc_lat + ',' + dataumum.wl_loc_lon }}</td>
                </tr>
                <tr bgcolor="#acb9ca">
                  <td>8</td>
                  <td>Kelas Jalan</td>
                  <td>:</td>
                  <td>{{dataumum.wl_road_class}}</td>
                </tr>
                <tr bgcolor="#d5dce4">
                  <td>9</td>
                  <td>Tanggal Pasang</td>
                  <td>:</td>
                  <td>{{dataumum.wl_install_date | date:'dd MMM yyyy' }} </td>
                </tr>
                  <tr bgcolor="#acb9ca">
                  <td>10</td>
                  <td>Umur Alat</td>
