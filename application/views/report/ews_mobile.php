...
<div class="content-wrapper" ng-controller='rEwsCtrl' style="margin-top: -30px;">
            ...
            <div class="col-sm-12 table table-responsive" style="margin-top: 10px;">
              <table class="table table-condensed table-bordered">
                ...
                <tr ng-repeat="his in datafilters">
                  ...
                  <td align="center">
                    <img ng-if="(his.ews_arah != 'NONE' && his.ews_arah != '')" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_merah_on.gif">
                  ...
                  <td align="center">
                    ...
                    <table class="" border="0">
                      <tr>
                        <td colspan="2" align="center">
                          <img class="img_icon_larger" ng-src="{{base_url}}image/indicator/{{his.arah_icon}}"><br>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="2"><img height="10" width="auto" ng-src="{{base_url}}image/indicator/arahBaruTanda.png"></td>
                  ...
                  <td align="center">
                    ...
                    <img ng-if="(his.ews_arah == 'NONE' || his.ews_arah == '')" class="img_icon" ng-src="{{base_url}}image/indicator/lampu_kuning_on.gif">
                  </td>
                  ...
                  <td align="center"><img class="img_icon_large" ng-src="{{base_url}}image/indicator/{{his.icon_status_toa}}"></td>
                </tr>
              </table>
            </div>
          </div>
