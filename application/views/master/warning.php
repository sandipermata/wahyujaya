...
<div class="content-wrapper" ng-controller='mWlCtrl'>
...
<!--     <button ng-click="startIntWl('1')">start 1</button>
    <button ng-click="startIntWl('2')">start 2</button>
    <button ng-click="startIntWl('3')">start 3</button>

    <input type="number" name="" ng-model="jml" >
    <button ng-click="startIntWl(jml)">start jml</button>

    <button ng-click="stopIntWl()">stop</button>


    <p>hallooo <b ng-show="show"> interval </b>  <i>{{timers}}</i>  </p>
 -->
    <div class="row" ng-show="s_main">
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Current Warning Light Data</h3>
              ...
              <div class="col-md-12">
                ...
                <div class="table table-responsive">
                  <table class="table table-condensed">
                    ...
                    <tbody ng-if="(warnings | filter:searchTable).length < 1">
                      <tr>
                        <td colspan="5"><b><i>No match data found</i></b></td>
                      </tr>
                    </tbody>
                    <tbody >
                      <tr ng-repeat-start="u in warnings | filter:searchTable">
                        <td>{{$index + 1}}</td>
                        ...
                        <td><a href="" ng-click="editData(u)" >{{u.wl_sn}}</a></td>
                        <td>{{u.wl_area}}</td>
                        <td>{{u.wl_loc_lat}},{{u.wl_loc_lon}}</td>
                        <td align="center">{{u.wl_cross_type}}</td>
                        <td align="center">
                          <img class="circle-image" ng-src="{{base_url}}image/bg/{{u.wl_loc_image}}">
                        </td>
                      </tr>
          ...
          <div class="box-body">
            ...
            <div class="form-horizontal" style="margin-bottom: 20px;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control input-sm" ng-model="wl.wl_sn" id="wl_sn" ng-readonly="on_edit">
                </div>
              </div>
...
<!--               <div class="form-group">
 ...
 -->
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <button class="btn btn-block btn-success btn-sm" ng-disabled="!wl.wl_sn" ng-click="selectArea()" ><i class="fa fa-search"></i> Cari</button>
                </div>
                <div class="col-sm-6">
                  <input type="text" class="form-control input-sm" id="wl_area" readonly >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control input-sm" ng-model="wl.wl_desa" placeholder="Nama Desa" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control input-sm" ng-model="wl.wl_jalan" placeholder="Nama Jalan" >
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="number" min="1" class="form-control input-sm" ng-model="wl.wl_cross_type">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control input-sm" ng-model="wl.wl_loc_lat" placeholder="Latitude" >
                </div>
                <div class="col-sm-2">
                  <input type="text" class="form-control input-sm" ng-model="wl.wl_loc_lon" placeholder="Longitude" >
                </div>
              </div>
                ...
                <div class="col-sm-8">
                  ...
                  <div class="form-horizontal" style="margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <select class="form-control select2" ng-model="wl.wl_road_class" id="wl_road_class" >
                          <option value="">&nbsp;</option>
                      ...
                      <div class="col-sm-4">
                        <select class="form-control select2" ng-model="wl.wl_road_type" id="wl_road_type" >
                          <option value="">&nbsp;</option>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control select2" ng-model="wl.wl_rambu" multiple="multiple" id="wl_rambu" >
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-horizontal" style="margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select class="form-control select2" ng-model="wl.wl_marka" id="wl_marka" >
                          <option value="">&nbsp;</option>
                    ...
                    <div class="form-group">
                      <label class="col-sm-4">Flash Count</label>
                      <div class="col-sm-8">
                        <input type="number" class="form-control input-sm" ng-model="wl.wl_flash_count" >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <div class="input-group date datepicker">
                          ...
                          <input type="text" class="form-control input-sm pull-right wl_install_year">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <div class="input-group date datepicker">
                          ...
                          <input type="text" class="form-control input-sm pull-right wl_maintenance_year">
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-sm-8">
                  <div class="form-horizontal" style="margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control input-sm" ng-model="wl.wl_photo_desc" >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" class="form-control input-sm" ng-model="wl.wl_street_view" >
                      </div>
                    </div>
                ...
                <div class="col-sm-12">
                  ...
                  <div class="form-horizontal" style="margin-bottom: 20px;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control input-sm" ng-model="wl.wl_cctv" >
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <select class="form-control select2" ng-model="wl.wl_project" id="wl_project" >
                          <option value="">Pilih</option>
                          <option ng-repeat="pro in projects" value="{{pro.proj_id}}">{{pro.proj_name}}</option>
                        </select>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <textarea class="form-control input-sm" style="resize: none;" rows="3" ng-model="wl.wl_description" ></textarea>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="col-sm-12">
              <div class="pull-right">
                <div class="row">
                  ...
                  <button class="btn btn-sm btn-success" ng-click="saveDataWL(wl, lokFile)" ><i class="fa fa-check"></i>&nbsp; Save &amp; Continue</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box-body">
            ...
            <table class="table table-condensed">
              ...
              <tr ng-repeat="ud in details">
                ...
                <td>{{$index + 1}}</td>
                <td>{{ud.wl_pole}}</td>
                <td>{{ud.wl_loc_desc}}</td>
                <td>
                  <img class="circle-image" ng-src="{{base_url}}image/wl/{{ud.wl_image}}">
                </td>
                <td align="right">
        ...
        <div class="modal-body">
          ...
          <div class="row form-horizontal">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  <select class="form-control select2" id="wl_prov">
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  <select class="form-control select2" id="wl_kab">
              ...
              <div class="form-group">
                <div class="col-sm-12">
                  <select class="form-control select2" id="wl_kec">
            ...
            <div class="col-sm-12">
              ...
              <div class="form-horizontal" style="margin-bottom: 20px;">
                ...
                <div class="form-group">
                  <label class="col-sm-4">SN</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control input-sm" ng-model="wld.wl_sn_d" readonly>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <input type="text" maxlength="2" class="form-control input-sm" ng-readonly="on_edit_d" capitalize ng-model="wld.wl_pole" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" class="form-control input-sm" ng-model="wld.wl_loc_lat" placeholder="Latitude" >
                  </div>
                  <div class="col-sm-4">
                    <input type="text" class="form-control input-sm" ng-model="wld.wl_loc_lon" placeholder="Longitude" >
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <textarea class="form-control" rows="3" style="resize: none;" ng-model="wld.wl_loc_desc" ></textarea>
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-sm-4">
                    <button class="btn btn-sm btn-success btn-block" ng-click="saveDataD(wld, gfile)" id="bSaveD" ><i class="fa fa-plus"></i> Add</button>
                  </div>
                </div>
